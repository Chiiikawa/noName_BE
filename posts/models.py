...
class Bookmark(models.Model):
    ...
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='bookmark_of_post')
...
class Comment(models.Model):
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='comments_of_post')   # Post 모델과 외래키 관계를 형성
    user = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='commets_of_user')    # User 모델과 외래키 관계를 형성
